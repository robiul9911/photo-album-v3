...
define('STUDENT_NAME', 'Robiul Hasan Rahim');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104362319');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Wednesday 10:15PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'photo-album-bucket-s3');
...
define('DB_NAME', 'photo-album-db');
// [ACTION REQUIRED] endpoint of RDS instance
define('DB_ENDPOINT', 'photo-album-db.cedkkzobbyh4.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance 
define('DB_USERNAME', 'robiul');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'Robiul#9911');
